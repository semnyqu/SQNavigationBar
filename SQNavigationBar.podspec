#
#  Be sure to run `pod spec lint SQNavigationBar.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of SQNavigationBar."
  ...
  s.homepage     = "http://EXAMPLE/SQNavigationBar"
  ...
  s.source       = { :git => "http://EXAMPLE/SQNavigationBar.git", :tag => "#{s.version}" }
